...
export default function IM81362() {
    ...
    return (
        <>
                    ...
                    <div className="">
                        <div className="">
                            ...
                            <div className="imoveis_desp">
                                <hr />
                                <h1>Casa em Vila Cordeiro com 120m²</h1>
                                <p>
                                    Rua Godói Colaço, 214 - São Paulo / SP
                                    Apt/Sala: - Bloco: - Andar:{" "}
                                </p>
                                <p>Finalidade: Venda</p>
                                <p>Valor da Locação: R$ 0,00</p>
                                <p>Valor da Venda: R$ 1.300.000,00 / Valor Sujeito a Confirmação</p>
                                <hr />
                                <h2>Descrição</h2>
                                <p>
                                    A casa tem 2 salas, cozinha, 3 quartos sendo
                                    dois com armários, 1 banheiro. Nos fundos
                                    tem quintal e uma edícula com 2 quartos e um
                                    banheiro. IPTU:.R$475,00 p/mês
                                </p>
                                <hr />
                                <InnerHTML
                                    className="center"
            ...
            <a
                href="http://maps.google.com/maps?q=&layer=c&cbll=-23.6189789,-46.6908857&cbp=11,0,0,0,0"
                style={{
                    position: "fixed",
                    zIndex: 99,
                    bottom: "190px",
