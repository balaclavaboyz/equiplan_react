...
export default function IM79922() {
                    ...
                    <div className="">
                        <div className="">
                            ...
                            <div className="imoveis_desp">
                                <hr />
                                <h1>Loja em Lapa com 228m²</h1>
                                <p>
                                    Rua Trajano, 93 - São Paulo / SP Apt/Sala: -
                                    Bloco: - Andar:{" "}
                                </p>
                                <p>Finalidade: Aluguel</p>
                                <p>Valor da Locação: R$ 4.500,00</p>
                                <p>Valor da Venda: R$ 0,00</p>
                                <hr />
                                <h2>Descrição</h2>
                                <p>4 banheiros, sem vaga. IPTU:.R$530,00</p>
                                <hr />
                                <InnerHTML
                                    className="center"
                                    html={googleMaps}
