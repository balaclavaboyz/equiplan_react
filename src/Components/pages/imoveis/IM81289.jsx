...
export default function IM81289() {
    ...
    return (
        <>
                    ...
                    <div className="">
                        <div className="">
                            ...
                            <div className="imoveis_desp">
                                <hr />
                                <h1>Casa em Vila Parque Jabaquara com 570m²</h1>
                                <p>
                                    Rua das Nhandirobas, 356 - São Paulo / SP
                                    Apt/Sala: - Bloco: - Andar:{" "}
                                </p>
                                <p>Finalidade: Venda</p>
                                <p>Valor da Locação: R$ 0,00</p>
                                <p>Valor da Venda: R$ 1.400.000,00 / valor sujeito a confirmação</p>
                                <hr />
                                <h2>Descrição</h2>
                                <p>
                                    Casa com 3 dormitórios sendo 2 suítes, sala,
                                    cozinha, galpão c/ mais 6 salas, garagem p/
                                    8 carros. IPTU:.R$12.000.00 p/ano
                                </p>
                                <hr />
                                <InnerHTML
                                    className="center"
            ...
            <a
                href="http://maps.google.com/maps?q=&layer=c&cbll=-23.6480285,-46.6466897&cbp=11,0,0,0,0"
                style={{
                    position: "fixed",
                    zIndex: 99,
                    bottom: "190px",
