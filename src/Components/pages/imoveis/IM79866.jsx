...
export default function IM79866() {
                    ...
                    <div className="">
                        <div className="">
                            ...
                            <div className="imoveis_desp">
                                <hr />
                                <h1>Galpão em Vila Romana com 130m²</h1>
                                <p>
                                    Rua Coriolano, 1248 - São Paulo / SP
                                ...
                                <hr />
                                <h2>Descrição</h2>
                                <p>Valor de locação com IPTU incluso.</p>
                                <hr />
                                <InnerHTML
                                    className="center"
                                    html={googleMaps}
