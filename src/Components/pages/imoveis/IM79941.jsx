...
export default function IM79941() {
                ...
                <div className="imoveis_context">
                    <div className="imovelGaleria">
                        ...
                        <div className="imoveis_desp">
                            <hr />
                            <h1>Salão Comercial em Vila Moraes com 40m²</h1>
                            <p>
                                Rua Angaturama, 1171 - São Paulo / SP Apt/Sala:
                                - Bloco: - Andar:{" "}
                            </p>
                            <p>Finalidade: Aluguel</p>
                            <p>Valor da Locação: R$ 1.600,00</p>
                            <p>Valor da Venda: R$ 0,00</p>
                            <hr />
                            <h2>Descrição</h2>
                            <p>Salão comercial com banheiro. IPTU:.R$70,00</p>
                            <hr />
                            <InnerHTML
                                className="center"
                                html={googleMaps}
