    ...
    return (
        ...
        <div className="container">
            ...
            <div className="indice_imoveis_wrapper">
                ...
                <div style={{display:'flex',gap:'1rem'}}><Link to="/IM80009">IM80009</Link><p>Casa em Brooklin Paulista com 92m²</p><p>Tipo: Venda</p><p>Valor Locação: R$ 0,00</p><p>Valor Venda: R$ 700.000,00</p></div>
