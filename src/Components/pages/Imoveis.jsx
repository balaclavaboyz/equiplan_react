    ...
    return (
        <>
            <div className="indice_imoveis_wrapper">
                ...
                <div style={{display:'flex',gap:'1rem'}}><Link to="/IM79886">IM79886</Link><p>Galpão em Americanópolis com 200m²</p><p>Tipo: Aluguel</p><p>Valor Locação: R$ 4.000,00</p><p>Valor Venda: R$ 0,00</p></div>
